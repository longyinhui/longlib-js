...
johnsonRod = {
    ...
    textarea_html: function (str) {
        if (!str) str = "";
        return "<img src='/img/je/expand2.gif' class='clickable expandCollapse2IMG' data-a='t' title='Expand/Collapse Textarea'>"
    ...
    expandCollapseTextarea: function (img_JQ) {
        ...
        if (ta_JQ.length) {
            ...
            el.src = "/img/je/" + (flag ? "collapse" : "expand") + "2.gif"
        }
    },
    ...
    liActions: {
        x: function (JQ) {
            jR.expandCollapseFormItem(JQ);
        }, //expand/collapse
        u: function (JQ) {
            jR.moveFormItem(JQ, 0);
        }, //up
        d: function (JQ) {
            jR.moveFormItem(JQ, 1);
        }, //down
        c: function (JQ) {
            jR.copyFormItem(JQ);
        }, //copy
        r: function (JQ) {
            jR.deleteFormItem(JQ);
        }, //remove
        t: function (JQ) {
            jR.expandCollapseTextarea(JQ);
    ...
    messageRight: function (img_JQ, html_str, fade_sec) {
        ...
        jR.messageClose_img_el.src = "/img/je/" + (fade_sec > 0 ? "countdown" : "popupClose") + ".gif";
